...
function (_React$Component) {
  function Keyframes() {
    ...
    return (_temp = _this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this, _this.guid = 0, _this.state = {
      primitive: undefined,
      props: {},
      oldProps: {},
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        rest = _objectWithoutProperties(_this$props, ["script", "from"]);
...
Keyframes.Spring = function (states) {
  return createFactory(Spring, states);
};

Keyframes.Trail = function (states) {
  return createFactory(Trail, states);
};

Keyframes.Transition = function (states) {
  return createFactory(Transition, states);
};

var createFactory = function createFactory(p, s) {
...
export { Spring, Keyframes, Transition, Trail, Parallax, ParallaxLayer, Animation, SpringAnimation, AnimatedValue, config, elements as animated, controller, interpolate$1 as interpolate, createAnimatedComponent };
