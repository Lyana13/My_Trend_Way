...
const Connected = connect(stateToProps, dispatchToProps, null, { forwardRef: true })(Home);

export default forwardRef((props, ref) =>
    <Connected {...props} ref={ref} />
);

// const Connected = connect(state => ({ value: state }), null, null, { forwardRef: true })(Home);
